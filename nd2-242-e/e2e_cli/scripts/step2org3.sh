...
echo
echo "========= Getting Org3 on to your e2e_cli network ========= "
echo
CHANNEL_NAME="$1"
DELAY="$2"
LANGUAGE="$3"
...
set -x
peer channel fetch 0 $CHANNEL_NAME.block -o orderer2.example.com:7050 -c $CHANNEL_NAME --tls --cafile $ORDERER_CA >&log.txt
res=$?
set +x
cat log.txt
...
echo
echo "========= Org3 is now halfway onto your e2e_cli network ========= "
echo
