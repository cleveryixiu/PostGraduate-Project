    ...
    get_block: function(req, res, function_name){
        ...
        Fabric_Client.newDefaultKeyValueStore({ path: store_path
            ...
            if (query_responses.header.number !=0 && query_responses.data.data[0].payload.header.channel_header.tx_id != 1) {
                ...
                console.log("Response is ", query_responses.data.data[0].payload.header.channel_header.tx_id);
                res.send(query_responses.header.number+" "+query_responses.data.data[0].payload.header.channel_header.tx_id)
